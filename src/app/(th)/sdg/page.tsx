...
export const metadata = {
  ...
  description: `รับออกแบบการสื่อสาร SDG องค์กร และงานวิจัยประเมินผลที่อ้างอิงในรายงานความยั่งยืนได้ — งานของศูนย์ฯ ครอบคลุมแล้ว ${coveredGoals} จาก 17 เป้าหมาย`,
  openGraph: {
