    ...
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-12 pt-20 md:pt-28">
        <SectionHeader
          ...
          title="ทุกโครงการของเราตอบเป้าหมายโลก"
          description="เราเชื่อว่าการสื่อสารที่ดีเปลี่ยนคุณภาพชีวิตได้จริง ทุกโครงการจึงถูกออกแบบให้ตอบเป้าหมายการพัฒนาที่ยั่งยืนอย่างน้อยหนึ่งข้อ และวัดผลลัพธ์ได้เสมอ เลือกเป้าหมายด้านล่างเพื่อดูผลงานในเรื่องนั้น"
        />
