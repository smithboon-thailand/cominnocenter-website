...
export const projects: Project[] = [
  ...
  {
    slug: "communication-research-evaluation",
    ...
    challenge:
      "หลายโครงการสื่อสารยังขาดกรอบการประเมินผลที่ชัดเจน ทำให้วัดผลกระทบได้ยาก",
    approach:
      "ออกแบบกรอบวิจัยและตัวชี้วัด เก็บข้อมูล และวิเคราะห์ผลเพื่อนำไปปรับปรุงโครงการ",
    impact:
      "ได้กรอบการประเมินที่องค์กรพันธมิตรสามารถนำไปใช้ต่อได้จริง",
  },
  {
