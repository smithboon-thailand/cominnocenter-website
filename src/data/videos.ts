...
export type Video = {
  ...
  hdThumb: boolean;
  /**
   * ภาพหน้าปกในเว็บเรา (path ไม่มีนามสกุล ต้องมีสามขนาดเหมือน ResponsiveArtwork) — ถ้ามีจะใช้แทน thumbnail
   * ของ YouTube ทั้งจอหลักและรายการ · วิดีโอเล่าสาระหลักของบทความใช้ภาพประจำบทความซึ่งเป็นเฟรมแรกของคลิปพอดี
   */
  poster?: string;
  /** หน้าในเว็บที่เกี่ยวกับคลิปนี้ เช่น หน้าบทสรุปงานวิจัย — แสดงเป็นลิงก์ใต้คำอธิบาย */
  href?: string;
};
