...
export const paperSummaries: PaperSummary[] = [
  ...
  },
  {
    ...
    th: {
      headline: "เลือกตั้งผู้ว่าฯ กทม. 2556: ยอดไลก์ไม่ได้แปลว่าคะแนนเสียง",
      question:
  ...
  },
  {
    ...
    th: {
      headline: "แคมเปญค้านเขื่อนแม่วงก์สำเร็จ ทั้งที่กรอบการเล่าเรื่องของสามฝ่ายไม่ตรงกันเลย",
      question:
  ...
  },
  {
    ...
    th: {
      headline: "เนื้อหาสุขภาพชุดเดียวใช้กับที่ทำงานทุกแบบไม่ได้ — เอกชน ราชการ และโรงงาน ต้องการคนละอย่าง",
      question:
  ...
  },
  {
    ...
    th: {
      headline: "ผู้ใช้แอปเรียกบริการภักดีเพราะบริการดี ไม่ใช่เพราะเห็นโฆษณา",
      question:
  ...
  },
  {
    ...
    th: {
      headline: "สามช่องทีวีถูกปรับเพราะรายงานข่าวจับตัวประกันที่โคราช แต่ไม่มีช่องไหนมองว่าตัวเองอยู่ในภาวะวิกฤต",
      question:
  ...
  },
  {
    ...
    th: {
      headline: "วัยเกษียณรับสารรณรงค์ลดเค็มจากเฟซบุ๊กมากที่สุด และ “ระดับการศึกษา” คือสิ่งที่ทำให้ความเชื่อด้านสุขภาพต่างกัน",
      question:
  ...
  },
  {
    ...
    th: {
      headline: "รายการบันเทิงไทยห่อการคุกคามทางเพศไว้ด้วยเสียงหัวเราะ และผู้ชมตอบด้วยการถอนการสนับสนุน",
      question:
  ...
  },
  {
    ...
    th: {
      headline: "ฟังเรื่องเล่าจากทุกฝ่ายในชายแดนใต้ แล้วปัญหาปรากฏเป็นห้ามิติ ไม่ใช่มิติเดียว",
      question:
  ...
  },
  {
    ...
    th: {
      headline: "แฟนรายการเล่าเรื่องผีเชื่อใจรายการมาก แต่ความเชื่อใจนั้นแทบไม่กลายเป็นการสนับสนุนที่มีค่าใช้จ่าย",
      question:
