...
const PATTERNS = [
  ...
  {
    name: "มาร์กดาวน์ตัวเอน *...* (ดอกจันเดี่ยว)",
    re: /\*[^\s*][^*\n]{0,80}?\*/g,
    why: "withEmphasis() แปลงเฉพาะ ** ดอกจันเดี่ยวจึงหลุดเป็นข้อความบนหน้าเว็บ (เจอ 8 หน้า 23 ก.ย. 2569 — ไม่มีใครเห็นเพราะกฎเดิมมองหาแต่ **)",
  },
  {
