...
const FORBIDDEN: { name: string; re: RegExp; why: string }[] = [
  ...
  {
    name: "ชื่อผู้ช่วยวิจัยที่สะกดผิด",
    re: /Chaemchaeng|ธวินท์/g,
    why: "ผู้ใช้ยืนยัน 3 ก.ย. 2569 ว่าที่ถูกคือ ธาวิน แจ่มแจ้ง / Thavin Jamjang — ชื่อผิดติดมาจากเว็บ Wix เดิม",
  },
  {
